      ...
      <head>
        ...
        <style>
          *{box-sizing:border-box;}
          ...
          .enlaces-generales{display:flex;gap:12px;max-width:460px;position:relative;z-index:1;flex-wrap:wrap;}
          .enlace-general{color:${MARCA.verdeOscuro};font-size:0.95rem;font-weight:800;text-decoration:none;
                           background:#FFFFFF;border:2px solid #FFFFFF;display:flex;align-items:center;gap:8px;
                           border-radius:100px;padding:14px 22px;box-shadow:0 6px 18px rgba(0,0,0,0.18);}
          .enlace-general:hover{background:${MARCA.oro};border-color:${MARCA.oro};color:#fff;transform:translateY(-2px);}
          .enlace-general.secundario{background:transparent;color:#fff;border-color:rgba(255,255,255,0.6);box-shadow:none;}
          .enlace-general.secundario:hover{background:rgba(255,255,255,0.15);border-color:#fff;}

          .precio-hero{display:inline-flex;align-items:center;gap:10px;background:rgba(255,255,255,0.14);
                       border:1px solid rgba(255,255,255,0.35);border-radius:100px;padding:9px 18px 9px 9px;
                       margin-bottom:26px;position:relative;z-index:1;}
          .precio-hero-badge{background:${MARCA.oro};color:#fff;font-size:0.68rem;font-weight:800;
                             padding:6px 12px;border-radius:100px;text-transform:uppercase;letter-spacing:0.03em;}
          .precio-hero-texto{color:#fff;font-size:0.88rem;font-weight:600;}
          .precio-hero-texto b{font-weight:800;font-size:1.05rem;}
          ...
          .acceso-split{display:flex;gap:16px;max-width:600px;position:relative;z-index:1;}
          .acceso-card{flex:1;display:block;text-decoration:none;border-radius:18px;padding:26px 24px;
                       transition:transform 0.15s;box-shadow:0 14px 34px rgba(0,0,0,0.26);border:2px solid transparent;}
          .acceso-card:active{transform:scale(0.98);}
          .acceso-card:hover{transform:translateY(-3px);}
          .acceso-card.cliente{background:rgba(255,255,255,0.98);}
          .acceso-card.negocio{background:${MARCA.oro};}
          .acceso-eyebrow{font-size:0.7rem;font-weight:800;text-transform:uppercase;letter-spacing:0.05em;
                           margin-bottom:10px;}
        ...
        <div class="hero">
          <div class="hero-izq">
            ...
            <div class="precio-hero">
              <span class="precio-hero-badge">Desde</span>
              <span class="precio-hero-texto"><b>$119.900 COP</b> · tarjeta + envío incluido</span>
            </div>

            <div class="enlaces-generales">
              <a class="enlace-general" href="/pedido">Pedir mi tarjeta →</a>
              <a class="enlace-general secundario" href="/conoce">Conoce Tapin</a>
              <a class="enlace-general secundario" href="/descubre">Descubrir negocios</a>
            </div>
