      ...
      <head>
        ...
        <style>
          *{box-sizing:border-box;}
          ...
          .landing-card-real{width:342px;height:266px;left:42px;top:82px;padding:23px 24px;overflow:hidden;border-radius:18px;transform:rotate(-4deg);background:linear-gradient(145deg,#fffefd,#f7f4ed);box-shadow:0 25px 46px rgba(4,41,25,.28),0 0 0 2px rgba(255,255,255,.8) inset;color:#161c18;display:flex;flex-direction:column;align-items:center}.landing-card-real:before{display:none}.landing-card-real .card-top{position:absolute;top:21px;left:0;right:0;display:flex;align-items:center;justify-content:space-between;padding:0 24px}.landing-card-real .card-top b{font-family:'Inter','Segoe UI',sans-serif;font-size:1.05rem;color:#222}.card-nfc{font:700 .54rem Arial;border:1.5px solid #222;border-radius:999px;padding:3px 5px;letter-spacing:.02em}.card-google-g{font-family:Arial,sans-serif;font-size:5rem;font-weight:800;line-height:1;margin-top:41px;background:conic-gradient(from 40deg,#4285f4 0 25%,#34a853 25% 43%,#fbbc05 43% 62%,#ea4335 62% 79%,#4285f4 79%);-webkit-background-clip:text;background-clip:text;color:transparent}.card-stars-real{font-size:1.52rem;letter-spacing:7px;color:#c88713;line-height:1;margin-top:5px}.card-review-copy{font:600 .78rem 'Inter','Segoe UI',sans-serif;margin-top:12px;color:#242824}.card-touch{position:absolute;width:48px;height:48px;bottom:13px;color:#191d1a}.landing-card-real img{display:none}@media(max-width:760px){.landing-card-real{width:278px;height:218px;left:26px;top:72px;padding:18px}.landing-card-real .card-top{top:16px;padding:0 18px}.card-google-g{font-size:4.1rem;margin-top:33px}.card-stars-real{font-size:1.2rem;letter-spacing:5px}.card-review-copy{font-size:.64rem;margin-top:8px}.card-touch{transform:scale(.8);bottom:4px}.landing-badge{right:16px;bottom:22px}}
        </style>
      </head>
      <body>
        <main class="public-landing">
          <header class="public-nav">
            ...
            <nav class="public-nav-links"><a href="#como-funciona">Cómo funciona</a><a href="#beneficios">Beneficios</a><a href="/conoce">Precios</a><a class="nav-cta" href="/pedido">Pedir tarjeta</a></nav>
          </header>
          <section class="landing-wrap landing-hero">
            ...
            <div class="landing-visual" aria-label="Tarjeta Tapin para reseñas de Google"><div class="landing-card landing-card-real"><div class="card-top"><b>Tapin</b><span class="card-nfc">NFC ))</span></div><div class="card-google-g">G</div><div class="card-stars-real">★★★★★</div><div class="card-review-copy">Déjanos una reseña en Google</div><svg class="card-touch" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23 26V15a3 3 0 116 0v10m0-5a3 3 0 116 0v6m-12 0V19a3 3 0 10-6 0v12l-3-3a3 3 0 00-4 4l8 9a10 10 0 008 4h4a10 10 0 0010-10V26" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 16c3 2 5 5 5 8M6 12c5 3 8 8 8 13" stroke="#d89d28" stroke-width="2.5" stroke-linecap="round"/></svg></div><div class="landing-badge"><b>Un toque.</b><span>Una reseña en segundos.</span></div></div>
          </section>
          ...
          <section class="landing-wrap section section-grid" id="beneficios">
            ...
            <div class="product-panel"><div class="product-art"><div class="mini-card"><b>Tapin</b><div>Google</div><div style="color:#d89d28;letter-spacing:2px;margin-top:7px;">★★★★★</div></div></div><div class="caption">Tu punto físico para recibir reseñas y conocer la actividad de tu negocio.</div></div>
          </section>
