      ...
      <head>
        ...
        <style>
          *{box-sizing:border-box;}
          ...
          @media(max-width:980px){.hero{padding:0;gap:0}.hero-izq,.hero-der{border-radius:0;flex:auto}.botones{flex-direction:column}.hero-izq{padding:52px 30px}.acceso-split{max-width:560px}.franja-features{max-width:560px}}@media(max-width:540px){.home-tap-scene{transform:scale(.7);transform-origin:left top;margin-bottom:-90px}.hero-izq{padding:40px 24px}.acceso-split{flex-direction:column}.acceso-card{min-height:0}.franja-features{display:none}}
        </style>
      </head>
      <body>
        <div class="hero">
          <div class="hero-izq">
            ...
            <div class="home-tap-scene" aria-label="Celular acercándose a una tarjeta Tapin">
              <div class="home-nfc-card"><div class="home-card-logo">Tapin</div><div class="home-card-google">Google</div><div class="home-card-stars">★★★★★</div><div class="home-card-copy">Déjanos una reseña<br>con un toque</div></div>
              <div class="home-wave"></div>
              <div class="home-phone"><div class="home-phone-screen"><span class="home-phone-brand">Tapin</span><div class="home-phone-google">Google</div><div class="home-phone-review">Déjanos una reseña<br><span style="color:#e6a322;letter-spacing:1px;">★★★★★</span></div></div></div>
            </div>
